...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, inplanes=64, zero_init_residual=False,
...
def resnet18(num_classes=1000, pretrained='imagenet'):
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], num_classes, pretrained, progress=True)


def resnet34(num_classes=1000, pretrained='imagenet'):
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], num_classes, pretrained, progress=True)


def resnet50(num_classes=1000, pretrained='imagenet'):
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], num_classes, pretrained, progress=True)


def resnet101(num_classes=1000, pretrained='imagenet'):
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], num_classes, pretrained, progress=True)


def resnet152(num_classes=1000, pretrained='imagenet'):
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], num_classes, pretrained, progress=True)
